...
struct CalculationService {
    ...
    func getInvestmentAmount(initialInvestmentAmount: Double,
        ...
        let dollarCostAveragingAmount = Double(initialDateOfInvestmentIndex) * monthlyDollarCostAveragingAmount
    ...
    initialInvestmentAmount: Double, monthlyDollarCostAveragingAmount: Double,
                                    initialDateOfInvestmentIndex: Int) -> Double {
